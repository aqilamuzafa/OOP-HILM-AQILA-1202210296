public class Sampan extends TransportasiAir {
    ...
    public Sampan(int jumlahKursi, int biaya, int layar, int jangkar) {
        super(jumlahKursi, biaya);
        this.layar=layar;
    }
    
    public void informasi(){
        System.out.println("Transportasi Air jenis Sampan dengan kursi berjumlah "+jumlahKursi+" ditetapkan biaya sebesar Rp." +biaya);
